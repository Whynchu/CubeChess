...
const PERSONA = Object.freeze({
  Red: { id: "red_aggressor", dangerWeight: 0.78, poolLimit: 106, maxRisk: 8.6, search: { budgetFraction: 0.39, rootCandidateLimit: 16, depth3CandidateLimit: 7, depth4CandidateLimit: 4, opponentMoveLimit: 12, selfMoveLimit: 14, minDepth3BudgetMs: 45, minDepth4BudgetMs: 85, replyWeight: 0.8, recoveryWeight: 0.74, counterReplyWeight: 0.56, blendFactor: 0.8 } },
  Orange: { id: "orange_raider", dangerWeight: 0.82, poolLimit: 102, maxRisk: 7.2, search: { budgetFraction: 0.39, rootCandidateLimit: 16, depth3CandidateLimit: 8, depth4CandidateLimit: 4, opponentMoveLimit: 12, selfMoveLimit: 13, minDepth3BudgetMs: 45, minDepth4BudgetMs: 82, replyWeight: 0.86, recoveryWeight: 0.7, counterReplyWeight: 0.57, blendFactor: 0.79 } },
  Yellow: { id: "yellow_opportunist", dangerWeight: 0.88, poolLimit: 98, maxRisk: 6.8, search: { budgetFraction: 0.38, rootCandidateLimit: 15, depth3CandidateLimit: 7, depth4CandidateLimit: 4, opponentMoveLimit: 13, selfMoveLimit: 13, minDepth3BudgetMs: 50, minDepth4BudgetMs: 90, replyWeight: 0.93, recoveryWeight: 0.68, counterReplyWeight: 0.58, blendFactor: 0.78 } },
  Green: { id: "green_swarm", dangerWeight: 0.82, poolLimit: 114, maxRisk: 7.6, search: { budgetFraction: 0.4, rootCandidateLimit: 17, depth3CandidateLimit: 8, depth4CandidateLimit: 4, opponentMoveLimit: 12, selfMoveLimit: 14, minDepth3BudgetMs: 45, minDepth4BudgetMs: 82, replyWeight: 0.9, recoveryWeight: 0.7, counterReplyWeight: 0.58, blendFactor: 0.79 } },
  ...
  Blue: { id: "blue_fortress", dangerWeight: 1.08, poolLimit: 98, maxRisk: 5.2, search: { budgetFraction: 0.4, rootCandidateLimit: 16, depth3CandidateLimit: 8, depth4CandidateLimit: 4, opponentMoveLimit: 14, selfMoveLimit: 13, minDepth3BudgetMs: 50, minDepth4BudgetMs: 90, replyWeight: 0.99, recoveryWeight: 0.68, counterReplyWeight: 0.62, blendFactor: 0.79 } },
