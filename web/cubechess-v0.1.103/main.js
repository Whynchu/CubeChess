...
function updateIdleAutoRotate(nowMs = performance.now()) {
  ...
  controls.rotateLeft(CAMERA_IDLE_ROTATE_RAD_PER_SEC * dtSec);
...
const AI_PERSONA_TUNING = Object.freeze({
  ...
  green_swarm: Object.freeze({
    ...
    candidateConfig: Object.freeze({ poolLimit: 104, minPerPiece: 3 }),
    searchConfig: Object.freeze({
      budgetFraction: 0.36,
      rootCandidateLimit: 15,
      depth3CandidateLimit: 7,
  ...
  blue_fortress: Object.freeze({
    ...
    candidateConfig: Object.freeze({ poolLimit: 84, minPerPiece: 2 }),
    searchConfig: Object.freeze({
      budgetFraction: 0.36,
    ...
    riskGate: Object.freeze({ maxCombinedRisk: 4.2, maxCounterRisk: 2.2 }),
  }),
  purple_controller: Object.freeze({
    ...
    candidateConfig: Object.freeze({ poolLimit: 92, minPerPiece: 2 }),
    searchConfig: Object.freeze({
      budgetFraction: 0.35,
      rootCandidateLimit: 14,
      depth3CandidateLimit: 6,
    ...
    riskGate: Object.freeze({ maxCombinedRisk: 5.8, maxCounterRisk: 3.4 }),
  }),
