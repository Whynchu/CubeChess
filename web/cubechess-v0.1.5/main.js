...
function createStartingPieces() {
  ...
  const kingCoreGeo = new THREE.SphereGeometry(0.22, 24, 24);
  const coreGeo = new THREE.SphereGeometry(0.18, 22, 22);
  const kingHaloGeo = new THREE.SphereGeometry(0.34, 20, 20);
  const haloGeo = new THREE.SphereGeometry(0.28, 18, 18);
