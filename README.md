...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.113/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.113 knight-forward opening formation experiment on top of the deeper search planner)
