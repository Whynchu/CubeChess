...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.62/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.62 charcoal visual theme + default lighting/decision tree)
