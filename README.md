...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.112/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.112 shared deeper search planner plus targeted purple controller upgrade)
