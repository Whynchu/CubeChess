...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.117/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.114 knight-forward AI tuning pass with organic queen restraint and leaner search)
