...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.89/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.89 multi-opponent objective penalties (table pressure + anti-helper))
