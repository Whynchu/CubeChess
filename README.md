...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.58/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.58 king-taken splash, elimination sweep, speed-aware preview, colored highlights)
