...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.81/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.81 AI evaluator diversity and anti-stale tuning pass)
