...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.72/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.72 turn scheduling avoids animation overlap stutter)
