...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.111/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.111 stronger floor pass: better non-queen coordination and seat-order-safe danger search)
