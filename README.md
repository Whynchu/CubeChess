...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.102/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.102 persona pass: red aggression up, green/pink risk relaxed)
