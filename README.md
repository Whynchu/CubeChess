...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.92/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.92 AI candidate-pruning and adaptive search tightening)
