...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.104/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.104 persona pass: red aggression up, green/pink risk relaxed)
