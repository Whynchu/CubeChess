...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.82/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.82 chaotic selection rerank + score-gap-aware top-K sampling telemetry)
