...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.60/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.60 updated 8-color player palette + UI label mapping)
