...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.95/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.95 glow hotfix: restore piece visibility and keep 10% aligned shell)
