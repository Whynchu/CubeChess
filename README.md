...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.107/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.107 corrected rotating seat order for lower-cycle corners)
