...
- `https://whynchu.github.io/CubeChess/cubechess-v0.1.96/`
...
- M4 autoplay viewer loop now visible in WebGL (v0.1.96 glow center-bias fix + persona search speed recovery)
